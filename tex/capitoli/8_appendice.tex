...
\captionof{listing}{File di configurazione dell'ambiente PlatformIO in VSCode}
\label{lst:platformio_ini}
\inputminted{ini}{../programmi/firmware/platformio.ini}

\section{Files di configurazione del firmware}
\captionof{listing}{File header con i parametri di configurazione}
\label{lst:config_h}
\inputminted{c++}{../programmi/firmware/lib/config/config.h}

\captionof{listing}{File sorgente con i parametri di configurazione}
\label{lst:config_cpp}
\inputminted{c++}{../programmi/firmware/lib/config/config.cpp}

\newpage

\section{Files del modulo con le funzioni di utilità}
\captionof{listing}{File header con le funzioni di utilità}
\label{lst:utils_h}
\inputminted{c++}{../programmi/firmware/lib/utils/utils.h}

\captionof{listing}{File sorgente con le funzioni di utilità}
\label{lst:utils_cpp}
\inputminted{c++}{../programmi/firmware/lib/utils/utils.cpp}

\newpage

\section{Files del modulo per la gestione degli errori}
\captionof{listing}{File header con le funzioni per la gestione degli errori}
\label{lst:error_h}
\inputminted{c++}{../programmi/firmware/lib/error/error.h}

\captionof{listing}{File sorgente con le funzioni per la gestione degli errori}
\label{lst:error_cpp}
\inputminted{c++}{../programmi/firmware/lib/error/error.cpp}

\newpage

\section{Files del modulo per il controllo attuatori}
\captionof{listing}{File header con le funzioni per il controllo degli attuatori}
\label{lst:actuators_h}
\inputminted{c++}{../programmi/firmware/lib/actuators/actuators.h}

\captionof{listing}{File sorgente con le funzioni per il controllo degli attuatori}
\label{lst:actuators_cpp}
\inputminted{c++}{../programmi/firmware/lib/actuators/actuators.cpp}

\newpage

\section{Files del modulo per la gestione del display lcd}
\captionof{listing}{File header con le funzioni per la gestione del display lcd}
\label{lst:lcd_h}
\inputminted{c++}{../programmi/firmware/lib/lcd/lcd.h}

\captionof{listing}{File sorgente con le funzioni per la gestione del display lcd}
\label{lst:lcd_cpp}
\inputminted{c++}{../programmi/firmware/lib/lcd/lcd.cpp}

\newpage

\section{Files del modulo per la gestione del sensore di temperatura e umidità SHT20}
\captionof{listing}{File header con le funzioni per la gestione del sensore SHT20}
\label{lst:sht20_h}
\inputminted{c++}{../programmi/firmware/lib/sht20/sht20.h}

\captionof{listing}{File sorgente con le funzioni per la gestione del sensore SHT20}
\label{lst:sht20_cpp}
\inputminted{c++}{../programmi/firmware/lib/sht20/sht20.cpp}

\newpage

\section{Files del modulo per la gestione delle comunicazioni seriali}
\captionof{listing}{File header con le funzioni per la gestione delle comunicazioni seriali}
\label{lst:serial_h}
\inputminted{c++}{../programmi/firmware/lib/serial/serial.h}

\captionof{listing}{File sorgente con le funzioni per la gestione delle comunicazioni seriali}
\label{lst:serial_cpp}
\inputminted{c++}{../programmi/firmware/lib/serial/serial.cpp}

\newpage

\section{Files del modulo per la gestione del controllore PID}
\captionof{listing}{File header con le funzioni per la gestione del controllore PID}
\label{lst:pid_h}
\inputminted{c++}{../programmi/firmware/lib/pid/pid.h}

\captionof{listing}{File sorgente con le funzioni per la gestione del controllore PID}
\label{lst:pid_cpp}
\inputminted{c++}{../programmi/firmware/lib/pid/pid.cpp}

\newpage

\section{File principale del firmware}
\captionof{listing}{File principale del firmware}
\label{lst:main_cpp}
\inputminted{c++}{../programmi/firmware/src/main.cpp}


\chapter{Programmi in MATLAB}
\section{Lettura dei dati dalla porta seriale}
\captionof{listing}{Funzione MATLAB per la lettura dei dati dalla porta seriale, salvataggio dei dati in un file csv e
aggiornamento dei grafici in tempo reale costuiti con i dati ricevuti}
\label{lst:serial_read}
\inputminted[tabsize=4]{matlab}{../matlab/serial_read.m}

\newpage

\section{Stampa dei grafici dei dati nei files csv}
\captionof{listing}{Funzione MATLAB per la stampa dei grafici utilizzando i dati contenuti in un file csv}
\label{lst:csv_read}
\inputminted[tabsize=4]{matlab}{../matlab/csv_read.m}

\newpage

\section{Calcolo delle prestazioni della risposta del PID}
\captionof{listing}{Funzione MATLAB per l'analisi delle prestazioni della risposta al gradino del controllore PID e la
stampa del grafico della risposta}
\label{lst:plot_info}
\inputminted[tabsize=4]{matlab}{../matlab/plot_info.m}
