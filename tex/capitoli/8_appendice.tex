...
\captionof{listing}[Funzione MATLAB per la gestione della comunicazione seriale]{Funzione MATLAB che si occupa della lettura
dei messaggi dalla porta seriale, del relativo parsing e salvataggio in un file csv e aggiornare i grafici di andamento delle
...
\captionof{listing}[Funzione MATLAB per visualizzare i grafici dei dati csv]{Funzione MATLAB per la stampa dei grafici
dell'andamento delle grandezze fisiche in funzione del tempo, utilizzando i dati raccolti nei file csv.}
\label{lst:plot_csv}
...
\captionof{listing}[Funzione MATLAB per l'analisi dati del primo test]{Funzione MATLAB per il calcolo del periodo di warm-up
a partire dai dati raccolti nei file csv durante il primo test previsto dalla normativa.}
\label{lst:test1_analysis}
\inputminted[tabsize=4]{matlab}{../matlab/test1_analysis.m}

\captionof{listing}[Funzione MATLAB per l'analisi dati del secondo test]{Funzione MATLAB per il calcolo delle metriche di
prestazione (overshoot, settling time ed errori a regime) con i dati raccolti nei file csv durante il secondo test previsto
dalla normativa.}
